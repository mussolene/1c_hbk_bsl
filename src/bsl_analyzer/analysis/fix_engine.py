"""
Auto-fix engine for bsl-analyzer.
...
From the CLI (--fix flag)::
    ...
    bsl-analyzer --check . --fix

Programmatic::

    from bsl_analyzer.analysis.fix_engine import apply_fixes, FIXABLE_RULES
...
from bsl_analyzer.analysis.diagnostics import Diagnostic
