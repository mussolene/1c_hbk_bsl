...
def extend_security_rule_tasks(
    ...
    *,
    ...
    bsl175_176_179_195 = ("BSL175", "BSL176", "BSL179", "BSL195")
    if any(engine._rule_enabled(code) for code in bsl175_176_179_195):
        rule_tasks.append(
            (
                "BSL175_176_179_195",
                lambda: engine._rule_bsl175_176_177_179_195_deprecated_api_diagnostics(
                    path, lines, symbols, calls, bsl175_176_179_195
                ),
            )
        )
