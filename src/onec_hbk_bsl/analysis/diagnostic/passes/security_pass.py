...
def extend_security_rule_tasks(
    ...
    *,
    ...
    if any(
        engine._rule_enabled(code) for code in bsl180_184_185_188_203_226_247_250_264_267_270_272
    ):
        rule_tasks.append(
            (
                "BSL180_184_185_188_203_226_247_250_264_267_270_272",
                lambda: engine._rule_bsl180_184_185_188_203_226_247_250_264_267_270_272_api_pool(
                    path,
                    lines,
                    bsl180_184_185_188_203_226_247_250_264_267_270_272,
                ),
    ...
    bsl175_176_177_179_195 = ("BSL175", "BSL176", "BSL177", "BSL179", "BSL195")
    if any(engine._rule_enabled(code) for code in bsl175_176_177_179_195):
        rule_tasks.append(
            (
                "BSL175_176_177_179_195",
                lambda: engine._rule_bsl175_176_177_179_195_deprecated_api_diagnostics(
                    path, lines, symbols, calls, bsl175_176_177_179_195
                ),
            )
        )
