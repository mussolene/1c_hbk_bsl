...
FORMATTER_KEYWORD_TEXT: dict[str, str] = {
    "процедура": "Процедура",
...
FORMATTER_DEDENT_BEFORE: frozenset[str] = frozenset(
    {
        "конецпроцедуры",
        "endprocedure",
        "конецфункции",
...
FORMATTER_INCREMENT_TOKEN_TYPES = frozenset(
    {
        "(",
        "?(",
        "PROCEDURE_KEYWORD",
...
FORMATTER_DECREMENT_TOKEN_TYPES = frozenset(
    {
        ")",
        "ELSIF_KEYWORD",
        "ELSE_KEYWORD",
...
FORMATTER_KEYWORD_TOKEN_TYPES = frozenset(
    {
        "IF_KEYWORD",
        "THEN_KEYWORD",
        "ELSIF_KEYWORD",
...
FORMATTER_PRIMITIVE_TOKEN_TYPES = frozenset(
    {
        "NULL_KEYWORD",
        "DATETIME",
        "number",
...
FORMATTER_STRING_PART_TYPES = frozenset({'"', "string_content", "|"})
