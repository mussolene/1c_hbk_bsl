...
|---|---|
| Код правила / Rule code | `BSL011` |
| Совместимый псевдоним / Compatible alias | `CognitiveComplexity` |
...
- Cluster fixture or probe: tests/test_diagnostics_core_snapshot.py::TestBsl011CognitiveComplexity
...
- Targeted tests: `./.venv/bin/python -m pytest tests/test_diagnostics_core_snapshot.py -q -k bsl011 --no-cov`
